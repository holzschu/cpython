 ...
 */
static void YY_Y_func_reduce(char** args, const npy_intp* dimensions, const npy_intp* steps,
                             void* data) {
...
static void from_wkb_func(char** args, const const npy_intp* dimensions, const const npy_intp* steps,
                          void* data) {
