...
class ImgcatViewer(UnixViewer):
    """
    The terminal viewer ``imgcat`` command.
    """

    def get_command_ex(self, file, **options):
        command = executable = "imgcat"
        return command, executable
    ...
    def show_file(self, path, **options):
        ...
        Display given file.
        """
        subprocess.Popen(["imgcat", path])
        return 1

class ViewViewer(UnixViewer):
    """
    The iOS viewer using the ``view`` command.
    """

    def get_command_ex(self, file, **options):
        command = executable = "view"
        return command, executable
    ...
    def show_file(self, path, **options):
        ...
        Display given file.
        """
        subprocess.Popen(["view", path])
        return 1


if sys.platform not in ("win32", "darwin", "ios"):  # unixoids
...
if sys.platform == "ios":
    if shutil.which("imgcat"):
        register(ImgcatViewer)
    if shutil.which("view"):
        register(ViewViewer)
